...
import frenchTI from "../data/sentences/TIFrenchSentences";
import englishTI from "../data/sentences/TIEnglishSentences";
...
export default function Home() {
  ...
  const [frenchTISentences, setFrenchTISentences] = useState(frenchTI);
  const [englishTISentences, setEnglishTISentences] = useState(englishTI);
