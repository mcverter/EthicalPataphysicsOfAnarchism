...
At this moment language is serving a research conducted in view of disengaging the otherwise than being or being's other outside of the themes in which they already show themselves, unfaithfully, as being's essence-but in which they do show themselves.
Language permits us to utter, be it by betrayal, this outside of being, this exception to being, as though being's other were an event of being.
Being, its cognition and the said in which it shows itself signify in a saying which, relative to being, forms an exception; but it is in the said that both this exception and the birth of cognition [la naissance de la connaissance] show themselves.
But the fact that the exception shows itself and becomes truth in the said can not serve as a pretext to take as an absolute the apophantic variant of the saying, which is ancillary or angelic.
...
When stated in propositions, the unsayable (or the anarchical) espouses the forms of formal logic; the beyond being is posited in doxic theses, and glimmers in the amphibology of being and beings - in which beings dissimulate being.
...
The essence claims to recover and cover over every exception - negativity, nihilation, and, already since Plato, non-being, which "in a certain sense is.
...
a type of writing, of committing oneself with the world, which sticks like ink to the hands that push it off?
...
But time is also a recuperation of all divergences, through retention, memory and history.
...
The signaling of this pre-original past in the present would not again be an ontological relation.
...
The non-present is incomprehendable by reason of its immensity or its "superlative" humility or for example, its goodness, which is the superlative itself.
...
What is exceptional in this way of being signaled is that I am ordered toward the face of the other.
...
That trace lights up as the face of a neighbor, ambiguously him before whom (or to whom, without any paternalism) and him for whom I answer. For such is the enigma or exception of a face, judge and accused.
...
It is the glory of transcendence.
...
Signification, saying - my expressivity, my own signifyingness qua sign, my own verbality qua verb - cannot be understood as a modality of being; the disinterestedness suspends essence.
...
To the diachronic past, which cannot be recuperated by representation effected by memory or history, that is, incommensurable with the present, corresponds or answers the unassumable passivity of the self.
...
Our inquiry concerned with the otherwise than being catches sight, in the very hypostasis of a subject, its subjectification, of an exception, a null-site on the hither side of the negativity which is always speculatively recuperable, an outside of the absolute which can no longer be stated in terms of being.
...
It is being which is understood in the - first or last - word, but the last saying goes beyond the being thematized or totalized.
...
Toward another culminates in a for another, a suffering for his suffering, without light, that is, without measure, quite different from the purely negative blinding of Fortune which only seems to close her eyes so as to give her riches arbitrarily.
...
Unless, that is, the naivety of the philosopher not call, beyond the reflection on oneself, for the critique exercised by another philosopher, whatever be the imprudences that that one will have committed in his turn, and the gratuity of his own saying.
...
Both being and the vision of being refer to a subject that has risen earlier than being and cognition, earlier than and on this side of them, in an immemorial time which a reminiscence could not recuperate as an a priori.
...
The difference between "who?" and "what? which is reflected in vocabulary and grammar would be only eidetic or essential, motivated by the nature or mode of being of the entity that is problematical.
...
Can he that looks place himself outside of the Absolute, and the look withdraw from the event of being, by hollowing out the fold of inwardness, in which knowledge is deposited, accumulates and is formulated?
...
Is the "who"-the spectator, the subjectivity, the soul - exhausted in this process of interiorization?
...
It is then necessary, in order that truth come about, that in one way or another this exception of inwardness be recuperated, that the exception enter under the rule, that within the being exposed be found the subject of knowledge, and the pulsation and respiration of the "soul" belong to or come back to being as a whole.
...
There is the same as this aim and the same as discovered, only discovered and amounting to the same - truth.
...
In it forms are illuminated where knowledge is awakened; in it being leaves the night, or, at least, quits sleep, that night of night, for an unextinguishable insomnia of consciousness.
...
This ambiguousness has not been dissipated by the notion of intentionality such as it was affirmed in Husserl's polemics against psychologism, where what was important was to distinguish radically between the psychic life of the logician, the intentional Erlebnis, and the ideality of the thematized logical formation, which transcends the psychic and lived experience.
...
Despite the complete overlapping of the perceived and the perception in the Ur-impression, the originary or primal impression, which ought to no longer let the light pass through, despite their strict contemporaneousness which is the presence of the present, despite the non-modification of this "absolute beginning of this generation - the primal source, that from which all others are continually generated," this today without a yesterday or a tomorrow-the primal impression is nonetheless not impressed without consciousness.
...
To suggest the difference between Being and entities, and the strange temporal itch, a modification without change, one resorts to metaphors taken from the temporal and not from time - such as process, act of being, disclosure or effectuation of being, or its passage. But being is the verb itself.
...
The identity of entities refers to a saying teleologically turned to the kerygma of the said, absorbing itself in it to the extent of being forgotten in it.  
...
It JO is not ontology that raises up the speaking subject; 
it is the signifyingness of saying going beyond essence that can justify the exposedness of being, ontology.
...
Time and the essence it unfolds by manifesting entities, identified in the themes of statements or narratives, resound as a silence without becoming themes themselves.
...
Once again for the "listening eye" a silence resounds about what had been muffled, the silence of the parceling out of being, by which entities in their identities are illuminated and show themselves.
...
Is this verb to redden, in which the immediate coincidence of the nominalized adjective, the red, with itself is abruptly diachronized, only a sign that, like a noun, designates a process, a succession of states, to the interlocutor, and doubles up the totality of entities and events with the system of signs of a language?
...
But identical entities, things and qualities of things, begin to resound with their essence in a predicative proposition not as a result of psychological reflection about subjectivity and the temporality of sensation, but out of art. Art is the pre-eminent exhibition in which the said is reduced to a pure theme, to absolute exposition, even to shamelessness capable of holding all looks for which it is exclusively destined.  The said is reduced to the Beautiful, which supports Western ontology.
...
The research of modern art, or, perhaps more exactly, art in the stage of search, a stage never overcome, seems in all its aesthetics to look for and understand this resonance or production of essence in the form of works of art.
...
They become states of affairs, Sachverhalte, in which words designate idealities identified first, substrates, as Husserl calls them, nuclei of things.
...
Every "lived state" (Erlebnis), lived in "temporal modification," in a parceling out of essence, is memorable, and thus can be named, identified, appear, be represented.
...
And the mutation is ambivalent, 
every nameable identity can turn into a verb.
...
Does not to tell oneself amounts to being said ("Se dire," revient-il a "etre dit") 
The reflexive pronoun oneself and the recurrence it denotes raise a problem; 
they can not be understood solely on the basis of the said.
...
e. The Reduction 
It is clear that the verb to be, or the verb to consist, is used in the formulas from these first pages that name the hither side of being. It is also clear that being makes its apparition, shows itself, in the said.
...
But one has to say that the gratuity none the less required of substitution, that miracle of ethics before the light, this astonishing saying, comes to light through the very gravity of the questions that assail it.
...
But one can go back to this signification of the saying, this responsibility and substitution, only from the said and from the question: "What is it about...?", a question already within the said in which everything shows itself.
...
The reduction, the going back to the hither side of being, to the hither side of the said, in which being shows itself, in which the eon is hypostatized, could nowise mean a rectification of one ontology by another, the passage from some apparent world to a more real world.
...
SAYING AND SUBJECTIVITY 
a. The Saying without the Said 
From the amphibology of being and entities in the said we must go back to the saying which signifies prior to essence, prior to identification, on the hither side of this amphibology. Saying states and thematizes the said, but signifies it to the other, a neighbor, with a signification that has to be distinguished from that borne by words in the said.
This signification to the other occurs in proximity. Proximity is quite distinct from every other relationship, and has to be conceived as a responsibility for the other; it might be called humanity, or subjectivity, or self.
...
Our task is to show that the plot proper to saying does indeed lead it to the said, to the putting together of structures which make possible justice and the "I think. " The said, the appearing, arises in the saying. Essence then has its hour and its time. Clarity occurs, and thought aims at themes. But all that is in function of a prior signification proper to saying, which is neither ontological nor ontic. Our task is to establish its articulation and signifyingness antecedent to ontology.
...
It imprints its trace on the thematization itself, which hesitates between, on the one hand, structuration, order of a configuration of entities, world and history for historiographers and, on the other hand, the order of non-nominalized apophansis of the other, in which the said remains a proposition, a proposition made to a neighbor, "a signifyingness dealt" (significance baillee) to the other.
...
This resonance is always ready to congeal into nouns, where being will be congealed into a copula and the Sachverhalt "nominalized. But the apophansis is still a modality of saying.
...
It refers to a saying on the hither side of the amphibology of being and entities.  This saying, in the form of responsibility for another, is bound to an irrecuperable, unrepresentable, past, temporalizing according to a time with separate epochs, in a diachrony.
An analysis that starts with proximity, irreducible to consciousness of..., and describable, if possible, as an inversion of its intentionality, will recognize this responsibility to be a substitution.
...
To say is to approach a neighbor, "dealing him signifyingness.
...
The "giving out of signs" would amount to a prior representation of these signs, as though speaking consisted in translating thoughts into words and consequently in having been first for-oneself and at home with oneself,\ like a substantial consistency. The relationship with the other would then extend forth as an intentionality, out of a subject posited in itself and for itself, disposed to play, sheltered from all ills and measuring by thought the being disclosed as the field of this play.
...
Intentionality remains an aspiration to be filled and fulfilment, the centripetal movement of a consciousness that coincides with itself, recovers, and rediscovers itself without ageing, rests in self-certainty, confirms itself, doubles itself up, consolidates itself, thickens into a substance.
...
The saying signifies this passivity; in the saying this passivity signifies, becomes signifyingness, exposure in response to..., being at the question before any interrogation, any problem, without clothing, without a shell to protect oneself, stripped to the core as in an inspiration of air, an ab-solution to the one, the one without a complexion.
It is a denuding beyond the skin, to the wounds one dies from, denuding to death, being as a vulnerability.
It is a fission of the nucleus opening the bottom of its punctual nuclearity, like to a lung at the core of oneself. The nucleus does not open this depth as long as it remains protected by its solid crust, by a form, not even when it is reduced to its punctuality, for it identifies itself in the temporality of its essence, and thus covers itself over again.
The limit of the stripping bare, in the punctual core, has to continue to be torn from itself. The one assigned has to open to the point of separating itself from its own inwardness, adhering to esse; it must be dis-interested.
...
The pain, this underside of skin, is a nudity more naked than all destitution. It is sacrificed rather than sacrificing itself, for it is precisely bound to the adversity or suffering of pain. This existence, with sacrifice imposed on it, is without conditions.
...
Saying, the most passive passivity, is inseparable from patience and pain, even if it can take refuge in the said, finding again in a wound the caress in which pain arises, and then the contact, and beyond it the knowing of a hardness or a softness, a heat or a cold, and then the thematization.
Of itself saying is the sense of patience and pain. In saying suffering signifies in the form of giving, even if the price of signification is that the subject run the risk of suffering without reason.
...
" The reverting of the ego into a self, the de-posing or de-situating of the ego, is the very modality of dis-interestedness. It has the form of a corporeal life devoted to expression and to giving. It is devoted, and does not devote itself: it is a self despite itself, in incarnation, where it is the very possibility of offering, suffering and trauma.
Then the for-the-other involved in saying must not be treated in terms of consciousness of..., thematizing intentionality, nor in terms of commitment.
...
But it is not possible that responsibility for another devolve from a free commitment, that is, a present; 
it exceeds every actual or represented present.
...
Already the synthesis of retentions and protentions in which Husserl's phenomenological analysis, through an abuse of language, recuperates the lapse, bypasses the ego.
...
But a kingdom of an invisible king, 
the kingdom of the Good whose idea is already an eon.
...
The Biblical notion of the Kingdom of God - kingdom of a non-thematizable God, a non-contemporaneous, that is, non-present, God - must not be conceived as an ontic image of a certain "epoque" of the "history of Being," as a modality of essence.
...
Being for death is patience, nonanticipation, a duration despite oneself, a form of obedience.
...
Prior to this participation, and as an element necessary for the participation in the verb which is realized in the participle, there is signaled the purely formal eventuality of the nominal form of the individual.
...
(Perhaps the "something" thematized in the direction of the finger that points, or Kant's "transcendental object," already owes its formal structure to it.) 
...
The subject then cannot be described on the basis of intentionality, representational activity, objectification, freedom and will; 
it has to be described on the basis of the passivity of time.
...
The subject is described as a self, from the first in the accusative form, (or under accusation!), already presupposed by "the infinite freedom of the equal" with which Hegel characterizes the return to self involved in consciousness and time.
...
Here it is as though a being, in being alienated, were only an eon of the kingdom, a modality of the necessities of being of service which characterize the "being for another," the "one for the other" involved in proximity. These necessities are more serious than being or not being.
...
Nor should one start with the opposition between a man and a society that binds him to labor while depriving him of the products of his labor.
...
e. The One 
The exposure to the other is not something added to the one to bring it from the inward to the outside.
...
Uniqueness signifies through the non-coinciding with oneself, the nonrepose in onself, restlessness. It is the reverse of certainty that falls back on itself; it does not identify itself and does not appear to knowing. It is in deficit, a point of pain.
But, like the unity of the Kantian "I think," it is undeclinable in this passivity without any play.
As an exception, and by abuse of language, one can name it me or I.
...
If this passivity is not reducible to the passivity of an effect in a causal relation, if it can be conceived to be on the hither side of freedom and non-freedom, it must have the meaning of a "goodness despite itself" a goodness always older than the choice. Its value, that is, its excellence or goodness, the goodness of goodness, is alone able to counterbalance the violence of the choice (and, beyond counterbalancing, be for the better!).
...
On the hither side of consciousness, they consist in this pre-original hold of the Good over it, always older than any present, any beginning. This diachrony prevents the one from joining up with itself and identifying itself as a substance, contemporary with itself, like a transcendental ego.
Uniqueness is without identity.
Not an identity, it is beyond consciousness, which is in itself and for itself. For it is already a substitution for the other.
...
The subject said as properly as possible (for the ground of saying is never properly said) is not in time, but is diachrony itself. In the identification of the ego, there is the ageing of him that one will never "catch up with there again.
" It is the diachrony of an election without identification, an election that impoverishes and denudes, a goodness that demands. This goodness consequently is not an attribute that would multiply the One, for if it were to multiply, if the One could be distinguished from the Goodness that sustains it, the One could take up a position with regard to its goodness, know itself to be good, and thus lose its goodness.
f Subjectivity and Humanity 
Concepts are ordered and unfold in truth (whose presuppositions, like conventions, make the combinations of concepts like a game), according to the logical possibilities of thought and the dialectical structures of being.
...
It turns out, as we will see in the course of this study, that, even if one neglects the fact that cognition makes its way in it, the human sphere approached as an object among others takes on significations that link up and implicate one another in such a way as to lead to extreme and irreducible conceptual possibilities, possibilities that go beyond the limits of a description, even if it is dialectical, of order and being, lead to the extraordinary, to what is beyond the possible. Such conceptual possibilities are substitution of one for another, the immemorable past that has not crossed the present, the positing of the self as a deposing of the ego, less than nothing as uniqueness, difference with respect to the other as nonindifference.
...
CHAPTER HI SENSIBILITY AND PROXIMITY 
I. SENSIBILITY AND COGNITION 
Truth can consist only in the exposition of being to itself, in a singular inadequacy with itself which is also an equality, a partition in which the part counts for the whole, is the image of the whole.
...
The subjective movement of cognition thus belongs to being's very essence, to its temporalization in which essence takes on sense, in which the image is already an idea, a symbol of another image, both theme and openness, pattern and transparency.
...
This activity of sentencing and judgement, thematization and theory, occurs in the saying as a pure for-another, a pure giving of signs, making oneself a sign, expression of self, sincerity, passivity.
...
The disclosed qua disclosed overflows itself as a symbol of this in that; it is identified in the this as that. It is then from the first claimed and said.
...
Understanding, without which the image would be immobilized, has the authority of a supreme and sovereign instance, proclaiming, promulgating the identity of this and that. This has long been recognized in philosophy, when it spoke of the spontaneity of understanding.
...
Sensation already functions as sensible intuition; it is the unity of the sensing and the sensed in the divergency, and recoveries, of temporality, where the past is rememberable. It is an identity in the discursiveness of the this and the that, the this as that, which ensures a being's presence to itself. Sensation is already the element of consciousness, and as such is the source of idealism, while at the same time breaking with idealism.
Berkeley's idealist sensualism, whose vigorous positions Husserl's phenomenology prolongs in our day, consists in reducing the sensible qualities of objects into contents experienced, in which, in an adequate possession of the sensed by the sensing, the immanent essence of consciousness, the coinciding of being with its manifestation, is found again. This is in fact the essence of idealism. It is also affirmed in contemporary ontology, in another form.
...
The dominant signification of sensibility is already caught sight of in vulnerability, and it will be shown in the responsibility characteristic of proximity, in its restlessness and its insomnia; it contains the motivation for its cognitive function.
...
To say that in sensibility this structure is secondary, and that sensibility qua vulnerability nonetheless signifies, is to recognize a sense somewhere else than in ontology. It is even to subordinate ontology to this signification beyond essence.
...
This immediacy is first of all the ease of enjoyment, more immediate than drinking, the sinking into the depths of the element, into its incomparable freshness, a plenitude and a fulfilment. It is pleasure, that is, the complacency in itself of life loving life even in suicide.
The complacency of subjectivity, a complacency experienced for itself, is its very "egoity," its substantiality.
But at the same time there is a coring out (denucleation), of the imperfect happiness which is the murmur of sensibility. There is a non-coinciding of the ego with itself, restlessness, insomnia, beyond what is found again in the present. There is the pain which confounds the ego or in vertigo draws it like an abyss, and prevents it from assuming the other that wounds it in an intentional movement when it posits itself in itself and for itself. Then there is produced in this vulnerability the reversal whereby the other inspires the same, pain, an overflowing of meaning by nonsense. Then sense bypasses nonsense - that sense which is the-same-for-the-other.
...
Not in elevated feelings, in "belles lettres," but as in a tearing away of bread from the mouth that tastes it, to give it to the other. Such is the coring out (denucleation) of enjoyment, in which the nucleus of the ego is cored out.
SENSIBILITY AND SIGNIFICATION 
A thermal, gustative or olfactory sensation is not primarily a cognition of a pain, a savor, or an odor.
No doubt it can take on this signification of being a discovery by losing its own sense, becoming an experience of... ,a consciousness of.., "placing itself' before the being exposed in its theme, in discourse, in which every commencement begins.
...
But does sensation succeed in staying between its beginning and its outcome?
...
Sensation, a "primary content" in the Logical Investigations, or a hyle in the Ideas, participates in the meaningful only inasmuch as it is animated by intentionality, or constituted immanent time according to the schema of theoretical consciousness of... in retention and protention, in memory and expectation.
Of course no one would deny that in the olfactory or the gustatory sensation the openness upon..., consciousness of..., or experience of... is not the dominant, that the enjoying or suffering which these sensations are do not signify like knowings, even if their signification shows itself in knowing.
...
But perhaps this prior cognition and comprehension in intentionality seem to so easily accommodate themselves to significations different from thematization only because Husserl himself imperceptively introduces into his description of intention an element that is different from pure thematization: intuition fills (that is, contents or satisfies) or deceives an aim aiming emptily as its object.
...
Intention is now taken as desire, such that intention, occurring between deception and Erfullung, already reduces the "objectifying act" to a specification of a tendency, rather than hunger being a particular case of "consciousness of...
"Consciousness of..., correlative with manifestation, a structure of every intentionality, would, on the other hand, be, in Husserl, founding of everything that shows itself, or even the essence of all that shows itself.
...
The interpretation of sensible signification in terms of consciousness of..., however little intellectualist one means it, does not account for the sensible.
...
When interpreted as openness of disclosure, as consciousness of..., sensibility would be already reduced to sight, idea and intuition, a synchrony of thematized elements and their simultaneity with the look.
...
To show the way non-representational sensations signify is to describe their psyche before identifying it with consciousness of..., thematizing consciousness, before finding in it the reflection of this diachrony.
...
The fact that one could not philosophize before the monstration in which sense is already a said, a something, a thematized, does not at all imply that monstration does not justify itself by signification. Signification may motivate monstration and be manifested in it as something betrayed, something to be reduced, that is, would be manifested in the said.
...
Nothing is changed when one enlarges the notion of consciousness of..., and describes it as an "access to Being.
" The exteriority that this way of speaking presupposes is already borrowed from thematization, consciousness of..., the self sufficient correlation of the saying and the said.
...
SENSIBILITY AND PSYCHE 
The psyche involved in intentionality does not lie in consciousness of..., its power to thematize, or in the "truth of Being," which is discovered in it through different significations of the said.
...
Qui pro quo, it is a substitution, extraordinary. It is neither a deception nor truth, but the preliminary intelligibility of signification. But it is an overwhelming of the order of the thematizable being in the said, of the simultaneity and reciprocity of the relations said.
...
Perception is understood by reference to memory and expectation, and perception, memory and expectation are united by their cognitive essence, their "impassiveness," and can be understood by opposition to the will, need, hunger - actively or passively restless. And these in turn are understood with reference to the serenity of the theoretical.
...
The meaning of perception, hunger, sensation, etc., as notions signifies through the correlation of terms in the simultaneity of a linguistic system.
...
This signification in its very signifyingness, outside of every system, before any correlation, is an accord or peace between planes which, as soon as they are thematized, make an irreparable cleavage, like vowels in a dieresis, maintaining a hiatus without elision. They then mark two Cartesian orders, the body and the soul, which have no common space where they can touch, and no logical topos where they can form a whole.
...
Signification is the-one-for-the-other which characterizes an identity that does not coincide with itself. This is in fact all the gravity of an animate body, that is, one offered to another, expressed or opened up!
This opening up, like a reverse conatus, an inversion of essence, is a relationship across an absolute difference. It is not reducible to any synchronic and reciprocal relationship which a totalizing and systematic thought would seek in it, the thought concerned with understanding the "unity of the soul and the body." It is neither a structure, nor an inwardness of a content in a container, nor a causality, nor even a dynamism, which still extends in a time that could be collected into a history.
...
The psyche or animation is the way a relationship between uneven terms, without any common time, arrives at relationship. Non-objectifiable, non-contemporaneous, it can only signify non indifference.
...
Nor by starting with consciousness of..., which retains aspects of this present in the form of knowings, information and messages, but divests being only of images like innumerable pelts (which makes possible the multiplication of a being on innumerable screens) under which the skin of a being, present "in flesh and bone," remains intact.
...
As manifestation, consciousness of... can be expressed in terms of subjectivity as well as in terms of being; 
there is strict correlation here.
...
To knowledge as symbolic aim corresponds being showing itself symbolically, significatively, in Husserl's sense, on the basis of an other than itself, and to intuition - being in its image as a presence (perception) or as an absence (imagination and memory).
Then the whole of the psyche can be interpreted as a knowing; the axiological and the practical, hunger and thirst, the gustative and the olfactory sensation, etc., show themselves as modalities of consciousness ... reaching objects cloaked with attributes of value.
...
One forgets justice, in which this simultaneity is aroused. Justice refers to a psyche, not, to be sure, as a thematization, but as the diachrony of the same and the other in sensibility.
...
It is a passivity more passive still than any passivity that is antithetical to an act, a nudity more naked than all "academic" nudity, exposed to the point of outpouring, effusion and prayer. It is a passivity that is not reducible to exposure to another's gaze.
It is a vulnerability and a paining exhausting themselves like a hemorrhage, denuding even the aspect that its nudity takes on, exposing its very exposedness, expressing itself, speaking, uncovering even the projection that the very form of identity confers upon it. It is the passivity of being-for-another, which is possible only in the form of giving the very bread I eat.
...
ENJOYMENT 
In a gustative sensation, sensibility does not consist in confirming the aim of hunger with an image or an aspect of a presence.
The description of all sensibility as a fulfilment, an Erfullung, or a deception of consciousness of... implies a hunger, which, without constituting the ultimate sense of the sensibility, still troubles the sensation now become a knowing.
...
" Matter carries on, "does its job" of being matter, "materializes" in the satisfaction, which fills an emptiness before putting itself into a form and presenting itself to the knowing of this materiality and the possession of it in the form of goods. Tasting is first satisfaction.
...
Beyond the multiplication of the visible in images, enjoyment is the singularization of an ego in its coiling back upon itself.
...
Without egoism, complacent in itself, suffering would not have any sense. It would lose the passivity of patience, if it were not at every moment an overflowing of sense by non-sense.
Enjoyment and the singularization of sensibility in an ego take from the supreme passivity of sensibility, from its vulnerability, its exposedness to the other, the anonymousness of the meaningless passivity of the inert. The possibility in suffering of suffering for nothing prevents the passivity in it from reverting into an act.
...
But giving has meaning only as a tearing from oneself despite oneself, and not only without me. And to be torn from oneself despite oneself has meaning only as a being torn from the complacency in oneself characteristic of enjoyment, snatching the bread from one's mouth.
...
The immediacy of the sensible is the immediacy of enjoyment and its frustration. It is the gift painfully torn up, and in the tearing up, immediately spoiling this very enjoyment. It is not a gift of the heart, but of the bread from one's mouth, of one's own mouthful of bread. It is the openness, not only of one's pocketbook, but of the doors of one's home, a "sharing of your bread with the famished," a "welcoming of the wretched into your house" (Isaiah ).
...
At the height of its gnoseological adventure everything in sensibility means intuition, theoretical receptivity from a distance (which is that of the look). But as soon as it falls back into contact, it reverts from grasping to being grasped, like in the ambiguity of a kiss. It reverts from the activity of being a hunter of images to the passivity of being prey, from being aim to being wound, from being an intellectual act of apprehension to apprehension as an obsession by another who does not manifest himself.
On the hither side of the zero point which marks the absence of protection and cover, sensibility is being affected by a non-phenomenon, a being put in question by the alterity of the other, before the intervention of a cause, before the appearing of the other. It is a pre-original not resting on oneself, the restlessness of someone persecuted - Where to be? How to be?
It is a writhing in the tight dimensions of pain, the unsuspected dimensions of the hither side. It is being torn up from oneself, being less than nothing, a rejection into the negative, behind nothingness; it is maternity, gestation of the other in the same.
...
In the proximity of contact arises every committed freedom, which is termed finite by contrast with the freedom of choice of which consciousness is the essential modality. Yet the effort is made to reduce all commitment to freedom.  
Astonished to find itself implicated in the world of objects  the theme of its free contemplation  consciousness will search in its memory for the forgotten moment in which unbeknownst to itself it allied itself with objects or consented to apperceive itself in union with them. Such a moment, when awakened by memory, would become, after the event, the instant of an alliance made in full freedom.
Such a reduction refuses the irreducible anarchy of responsibility for another.
Maternity, vulnerability, responsibility, proximity, contact - sensibility can slip toward touching, palpation, openness upon..., consciousness of..., pure knowing taking images from the "intact being," informing itself about the palpable quiddity of things.
...
The saying extended toward the said is a being obsessed by the other, a sensibility which the other by vocation calls upon and where no escaping is possible. At least no escape is possible with impunity. The other calls upon that sensibility with a vocation that wounds, calls upon an irrevocable responsibility, and thus the very identity of a subject.
Signification is witness or martyrdom. It is intelligibility before the light, before the present of the initiative with which the signification of logos in its present, in its synchrony, signifies being.
To stay with the signification of the said, and of the saying that turns into apophansis, forgetful of the proposition and exposure to the other in which they signify, is to stay with the consciousness-subject, that is, in the last analysis, the subject self-consciousness and origin, archē, to which Western philosophy leads.
...
The effort is made to understand it on the basis of an incarnation as an avatar of the representation of oneself, as a deficiency of this representation, the occultation of a translucid and spontaneous consciousness into receptivity and finitude.
...
Not because, as preoriginal, it would be more originary than the origin, but because the diachrony of sensibility, which cannot be assembled in a representational present, refers to an irrecuperable pre-ontological past, that of maternity. It is a plot which cannot be subordinated to the vicissitudes of representation and knowledge, openness upon images, or an exchange of information.
What seems incomprehensible in a humanity of flesh and blood to the Cartesian conception - the animation of a body by thought, which is nonsense according to the intelligibility of a system, in which animation is understood only in terms of union and dovetailing and requires a deus ex machina - outlines signification itself: the-one-for-the-other. In the subject it is precisely not an assembling, but an incessant alienation of the ego (isolated as inwardness) by the guest entrusted to it. Hospitality, the-one- for-the-other in the ego, delivers it more passively than any passivity from links in a causal chain. Being torn from oneself for another in giving to the other the bread from one's mouth is being able to give up one's soul for another.
...
But this impossibility of being together is the trace of the diachrony of the-one-for-the-other. That is, it is the trace of separation in the form of inwardness, and of the for-the-other in the form of responsibility.
...
There is indeed an insurmountable ambiguity there: the incarnate ego, the ego of flesh and blood, can lose its signification, be affricated as an animal in its conatus and its joy.
It is a dog that recognizes as its own Ulysses coming to take possession of his goods.
But this ambiguity is the condition of vulnerability itself, that is, of sensibility as signification. For it is in the measure that sensibility is complacent in itself, is coiled over upon itself, is an ego, that in its benevolence for the other it remains for the other, despite itself, non-act, signification for the other and not for itself.
...
The pathos of the philosophy of existence directed against the intellectualism of reflexive philosophy was due to the discovery of a psyche irreducible to knowing.
...
The ontic, which at least involves an opaqueness, everywhere yields before the ontological, before a covered-over luminosity to be disengaged. The existentiell reveals its meaning in the existential, which is an articulation of ontology.
...
Would proximity be a certain measure of the interval narrowing between two points or two sectors of space, toward a limit of contiguity and even coincidence?
...
Narcissism would then find in the granite of things but a surface that would refer to men the echoes and reflections of their humanity.
...
In fact, the impassiveness of space refers to the absolute coexistence, to the conjunction of all the points, being together at all points without any privilege, characteristic of the words of a language before the mouth opens. It refers to a universal homogeneity derived from this assembling, from being's nonsubjective essence.
...
Not all spirituality is that of theoretical, voluntary or affective representation in an intentional subject. Far from marking a point of departure, the intentional subject refers to the unity of transcendental apperception itself issued from a whole metaphysical tradition.
...
Proximity is not a state, a repose, but, a restlessness, null site, outside of the place of rest. It overwhelms the calm of the nonubiquity of a being which becomes a rest in a site. No site then, is ever sufficiently a proximity, like an embrace.
...
The subjectivity of the approaching subject is then preliminary, anarchic, prior to consciousness, an implication, a being caught up in fraternity.
...
Humanity, to which proximity properly so called refers, must then not be first understood as consciousness, that is, as the identity of an ego endowed with knowledge or (what amounts to the same thing) with powers.
...
Proximity is no longer in knowing in which these relations with the neighbor show themselves, but do so already in narration, in the said, as an epos and a teleology 
The "three unities" are not exclusively a matter of theatrical action; they command every exposition, assemble into a history, a narration, a tale, the bifid or bifocal relationship with the neighbor.
...
Obsession as non-reciprocity itself does not relieve any possibility of suffering in common.  It is a one-way irreversible being affected, like the diachrony of time that flows between the fingers of Mnemosyne. It is tied into an ego that states itself in the first person, escaping the concept of an ego in an ipseity-not in an ipseity in general, but in me.
...
Signifyingness, the-one-for-the-other, exposedness of self to another, it is immediacy in caresses and in the contact of saying. It is the immediacy of a skin and a face, a skin which is always a modification of a face, a face that is weighted down with a skin.
...
If to this subjectivity in the last analysis themes and objects are proposed and given, its being excepted from order does not consist in its assuming the given, representing it, becoming conscious of it (whether in knowledge of objects or self knowledge, or in power exercised over the world or over oneself)
The proper signification of subjectivity is proximity, but proximity is the very signifyingness of signification, the very establishing of the-one-for-the- other, the establishing of the sense which every thematized signification reflects in being.
...
The exception of proximity to a rational order, tending in principle toward a system of pure relations, is the hypostasis of the relationship into a subjectivity obsessed, with a non-reciprocatable obsession, by the neighbor. This obsession is not reducible to an intersection of these relations, which would count by virtue of its "universal essence.
...
It is both the relation and the term of the relation.  But it is as subject to an irreversible relation that the term of the relation becomes a subject.
...
And it is probably starting with proximity that the difficult problem of an incarnate subjectivity has to be broached. One would like a subject to be obstinately free, and yet even an intentional subject gives itself a non-ego in representations, and paradoxically finds itself caught up in its own representations.
...
Proximity is to be described as extending the subject in its very subjectivity, which is both a relationship and a term of this relationship.
...
Is it a τόδε τi?
But a τόδε τi, even when unique in its genus, is set in its genus, even if that genus has no extension.
It still appears through what Husserl calls the "empty horizon of the unknown and the known," the a priori horizon which already puts the τόδε τi back into a whole, into a conjuncture or a correlation (at least the correlation it forms with the finger that designates it).
The neighbor qua other does not have himself be preceded by any precursor who would depict or announce his silhouette.
He does not appear.
What sort of signaling could he send before me which would not strip him of his exclusive alterity?
...
Not coming to confirm any signaling made in advance, outside of everything, a priori, the neighbor concerns me with his exclusive singularity without appearing, not even as a τόδε τι.
...
I am bound to him, him who is, however, the first one on the scene, not signaled, unparalleled; I am bound to him before any liaison contracted.
...
A fraternity that cannot be abrogated, an unimpeachable assignation, proximity is an impossibility to move away without the torsion of a complex, without "alienation" or fault.  This insomnia is the psyche.
The neighbor assigns me before I designate him. This is a modality not of a knowing, but of an obsession, a shuddering of the human quite different from cognition.
...
It is a surplus of passivity which is no longer consciousness of..., identifying this as that, ascribing a meaning.
...
The delay is irrecuperable.
"I opened ... he had disappeared.
...
Already he allows me an "as for me," distances, remains commensurable, to the scale of my power and of my present in which I am capable of..., capable of accounting for everything by my own identity.
...
In the obsession with this nudity and this poverty, this withdrawal or this dying, where synthesis and contemporaneousness are refused, proximity, as though it were an abyss, interrupts being's unrendable essence.
...
But it is life that is still not arrested in the absolute immobility of a death mask. The ending up of finitude is not an appearance, which Hegel was able to designate as "a being which immediately is its own nothingness.
" This existence abandoned by all and by itself, a trace of itself, imposed on me, assigns me in my last refuge with an incomparable force of assignation, inconvertible into forms. Forms would give me at once a countenance, would accord me a delay for representation, and would put off the urgency of the assignation already missed. I would be diverted by images, with which the neighbor annuls his proximity, pays with empty money and is paid with words. Thus would be established an activity of a subject, a domination of the world, even if the world resists.
A face is a trace of itself, given over to my responsibility, but to which I am wanting and faulty. It is as though I were responsible for his mortality, and guilty for surviving. A face is an anachronous immediacy more tense than that of an image offered in the straightforwardness of an intuitive intention.
...
In this the emptiness of an abandonment, or - equivocation to be demystified! - merely extension, a medium indifferent to the comings and goings of men, penetrable like nothingness, thinkable before all proximity?
Or, despite the demystification, is it emptiness again, obsessive as in agoraphobia, the trace of a passage or trace of what could not enter? Is it the trace of the excession, the excessive, of what could not be contained, of the non-content, disproportionate to all measure and all capacity, the trace of the infinite signifying diachronically exactly through these ambiguities?
The empty space of what could not be collected there is the trace of a passage which never became present, and which is possibly nothingness. But the surplus over pure nothingness, an infinitesimal difference, is in my non-indifference to the neighbor, where I am obedient as though to an order addressed to me. Such an order throws a "seed of folly" into the universality of the ego. It is given to me who answer before the one for whom I am responsible. The preoriginal here does not have to get its origin in a present of appearing.
The passivity of obsession, where consciousness no longer veils the unassumable assignation which comes from the neighbor, is not another name for naive consciousness, the immediacy prior to philosophy.
...
In thematization, the plastic character of an object, the form, clothes and protects the ego apparently exposed to critique. Apperceiving itself as universal, it has already slipped away from the responsibilities to which I-always contrasting with the ego-am bound, and for which I cannot ask replacements.
...
It is always to empty oneself anew of oneself, to absolve oneself, like in a hemophiliac's hemorrhage. It is to be on the hither side of one's own nuclear unity, still identifiable and protected; it is to be emptied even of the quasi-formal identity of a being someone.
...
This passivity is the way opposed to the imperialism of consciousness open upon the world. This passivity, this undeclinability due to a responsibility that cannot be declined, this for-the-other, could not be treated in terms of finitude in the pejorative or tragic sense of the term, a congenital and lamentable powerlessness to detach oneself from oneself and reflect totally on oneself.
...
" But the least intoxicated and the most lucid humanity of our time, at the moments most free from the concern "that existence takes for its very existence" has in its clarity no other shadow, in its rest no other disquietude or insomnia than what comes from the destitution of the others. Its insomnia is but the absolute impossibility to slip away and distract oneself.
e. Proximity and Infinity 
A trace lost in a trace, less than nothing in the trace of an excessive, but always ambiguously (trace of itself, possibly a mask, in a void, possibly nothingness or "pure form of the sensibility"), the face of the neighbor obsesses me with this destitution.
"He is looking at me" - everything in him looks at me; nothing is indifferent to me.
Nothing is more imperative than this abandon in the emptiness of space, this trace of infinity which passes without being able to enter.  In it is hollowed out the face as a trace of an absence, as a skin with wrinkles.
...
It is a trace of itself, a trace in the trace of an abandon, where the equivocation is never dissipated. It obsesses the subject without staying in correlation with him, without equaling me in a consciousness, ordering me before appearing, in the glorious increase of obligation.
...
Is the question of existence or non-existence the ultimate question?
...
But that would show the prestige of the totality and of efficacity, to which a philosophy of being would unfailingly return, and from which come the popular certainties.
To state the problem of the existence of God, despite signification, despite the-one-for-the-other, which derogates from the finality of the interestedness of man inhabiting the world, is to hold to the unity of being and the univocity of its esse, which, despite the multiplicity of its modalities, would be verified in efficacity, in action and in the resistance to action, would "enter into account," figure in the calculation that accompanies projects.
Then there sinks away, as illusion or luxurious subtleties of satisfied consciousness, all the differences of dignity, height and distance; there are filled all the abysses of transcendence, all the intervals that cut across "analogical unity.
...
One can contest the thesis that being signifies behind the-one-for-the-other, and put forth the Platonic word, Good beyond being. It excludes being from the Good, for how could one understand the conatus of being in the goodness of the Good?
...
By reducing as far as possible the ideology of a subject inhabiting the world as a man to the evidences of a transcendental ego, by excluding also, in conformity with Western rationalism, every sort of transcendence in the structures which the subject uncovers, and whose scope and horizons he fixes, Husserl situates the signifyingness of significations in the "signitive intentions" which fill objects with their "real presence.
...
Paul Celan 
I. PRINCIPLE AND ANARCHY 
In the relationship with beings, which we call consciousness, we identify beings across the dispersion of silhouettes in which they appear; in self- consciousness we identify ourselves across the multiplicity of temporal phases.
...
This identification is not the counterpart of any image; 
it is a claim of the mind, proclamation, saying, kerygma.
...
Being a theme, being intelligible or open, possessing oneself, the moment of having in being - all that is articulated in the movement of essence,
losing itself and finding itself out of an ideal principle, an άρχή, in its thematic exposition, being thus carries on its affair of being.
...
it is self-possession, sovereignty, άρχή.
Anything unknown that can occur to it is in advance disclosed, open, manifest, is cast in the mound of the known, and cannot be a complete surprise.
...
It is the relationship with what is not disproportionate to the άρχή's thematization, but incommensurable with it, with what does not derive its identity from the kerygmatic logos, and blocks all schematism.
...
It is not that the "beyond" would be "further" than everything that appears, or "present in absence," or "shown by a symbol"; 
that would still be to be subject to a principle, to be given in consciousness.
...
This way of passing, disturbing the present without allowing itself to be invested by the apxp of consciousness, striating with its furrows the clarity of the ostensible, is what we have called a trace.
...
The relationship with exteriority is "prior" to the act that would effect it. For this relationship is not an act, not a thematizing, not a position in the Fichtean sense.
...
Obsession is irreducible to consciousness, even if it overwhelms it.  In consciousness it is betrayed, but thematized by a said in which it is manifested. Obsession traverses consciousness countercurrentwise, is inscribed in consciousness as something foreign, a disequilibrium, a delirium.It undoes thematization, and escapes any principle, origin, will, or arche,which are put forth in every ray of consciousness.
This movement is, in the original sense of the term, anarchical.
...
It cannot be defined in terms of intentionality, where undergoing is always also an assuming, that is, an experience always anticipated and consented to, already an origin and άρχή.
...
A being is equal to itself and is in possession of itself in this form; 
domination is in consciousness as such. Hegel thought that the / is but consciousness mastering itself in self-equality, in what he calls "the freedom of this infinite equality." 
The obsession we have seen in proximity conflicts with this figure of a being possessing itself in an equality, this being άρχή.
How can the passivity of obsession find a place in consciousness, which is wholly, or is in the end, freedom? For in consciousness everything is intentionally assumed. Consciousness is wholly equality (equality of self with self, but also equality in that for consciousness responsibility is always strictly measured by freedom, and is thus always limited).
...
RECURRENCE 
But consciousness, knowing of oneself by oneself, is not all there is to the notion of subjectivity.
...
The who or the me are not even suspected. This one is a nonrelation, but absolutely a term.Yet this term of an irreversible assignation is perhaps dissimulated, under the outdated notion of the soul.
It is a term not reducible to a relation, but yet is in recurrence. The ego is in itself like a sound that would resound in its own echo, the node of a wave which is not once again consciousness.
...
Otherwise essence, exonerated by itself, constituted in immanent time, will posit only indiscernible points, which would, to be sure, be together, but which would neither block nor fulfill any fate.
...
The oneself has not issued from its own initiative, as it claims in the plays and figures of consciousness on the way to the unity of an Idea. In that Idea, coinciding with itself, free inasmuch as it is a totality which leaves nothing outside, and thus, fully reasonable, the oneself posits itself as an always convertible term in a relation, a self-consciousness.
...
It is by this hypostasis that the person, as an identity unjustifiable by itself and in this sense empirical or contingent, emerges substantively. In its stance it is resistant to the erosion of time and history, that is, struck by a death always violent and premature.
...
This is an inversion in the process of essence, a withdrawing from the game that being plays in consciousness. It is a withdrawal in-oneself which is an exile in oneself, without a foundation in anything else, a non-condition.
...
This describes the relation in which a subject is immolated without fleeing itself, without entering into ecstasy, without taking a distance from itself, in which it is pursued into itself, to the hither side of rest in itself, of its coincidence with itself. This recurrence, which one can, to be sure, call negativity (but a negativity antecedent to discourse, the unexceptionable homeland of dialectical negativity), this recurrence by contraction, is the self.
...
It lies behind the distinction between rest and movement, between the being at home with oneself (Chez soi) and wandering, between equality and difference. This negativity reminds us of the formulas of the Parmenides concerning the moment in which the One "being in motion... (it) comes to a stand, or being at rest, (..) changes to being in motion," and in which it "must not be at any time." ( c).
...
But obsession is anarchical; 
it accuses me beneath the level of prime matter.
...
It is not by chance that Plato teaches us that matter is eternal, and that for Aristotle matter is a cause; 
such is the truth for the order of things.
...
Or do the being encumbered with oneself and the suffering of constriction in one's skin, better than metaphors, follow the exact trope of an alteration of essence, which inverts, or would invert, into a recurrence in which the expulsion of self outside of itself is its substitu Ill tion for the other? Is not that what the self emptying itself of itself would really mean?
...
The face of the neighbor in its persecuting hatred can by this very malice obsess as something pitiful. This equivocation or enigma only the persecuted one who does not evade it, but is without any references, any recourse or help (that is its uniqueness or its identity as unique!) is able to endure.
...
Obsessed with responsibilities which did not arise in decisions taken by a subject "contemplating freely," consequently accused in its innocence, subjectivity in itself is being thrown back on oneself. This means concretely: accused of what the others do or suffer, or responsible for what they do or suffer.
...
Everything is from the start in the accusative. Such is the exceptional condition or unconditionality of the self, the signification of the pronoun self for which our Latin grammars themselves know no nominative form.
...
SUBSTITUTION 
In this exposition of the in itself of the persecuted subjectivity, have we been faithful enough to the anarchy of passivity?
...
In this context, this said, is already effaced the absolute diachrony of creation, refractory to assembling into a present and a representation. But in creation, what is called to being answers to a call that could not have reached it since, brought out of nothingness, it obeyed before hearing the order.
Thus in the concept of creation ex nihilo, if it is not a pure nonsense, there is the concept of a passivity that does not revert into an assumption. The self as a creature is conceived in a passivity more passive still than the passivity of matter, that is, prior to the virtual coinciding of a term with itself.
The oneself has to be conceived outside of all substantial coinciding of self with self. Contrary to Western thought which unites subjectivity and substantiality, here coinciding is not the norm that already commands all non-coinciding, in the quest it provokes.
...
The ipseity, in the passivity without archē characteristic of identity, is a hostage.
...
Recurrence becomes identity in breaking up the limits of identity, breaking up the principle of being in me, the intolerable rest in itself characteristic of definition.
...
It is to hold on to oneself while gnawing away at oneself. Responsibility in obsession is a responsibility of the ego for what the ego has not wished, that is, for the others.
This anarchy in the recurrence to oneself is beyond the normal play of action and passion in which the identity of a being is maintained, in which it is. It is on the hither side of the limits of identity. This passivity undergone in proximity by the force of an alterity in me is the passivity of a recurrence to oneself which is not the alienation of an identity betrayed. What can it be but a substitution of me for the others?
...
Its responsibility for the other, the proximity of the neighbor, does not signify a submission to the nonego; it means an openness in which being's essence is surpassed in inspiration. It is an openness of which respiration is a modality or a foretaste, or, more exactly, of which it retains the aftertaste.
...
For the venerable tradition to which Hegel refers, the ego is an equality with itself, and consequently the return of being to itself is a concrete universality, being having separated itself from itself in the universality of the concept and death. But viewed out of the obsession of passivity, of itself anarchical, there is brought out, behind the equality of consciousness, an inequality.
...
It signifies an inequality in the oneself due to substitution, an effort to escape concepts without any future but attempted anew the next day. It signifies a uniqueness, under assignation, of responsibility, and because of this assignation not finding any rest in itself.
The self without a concept, unequal in identity, signifies itself in the first person, setting forth the plane of saying, pro-ducing itself in saying as an ego or as me, that is, utterly different from any other ego, that is, having a meaning despite death. Contrary to the ontology of death this self opens an order in which death can be not recognized.
An identity in diastasis, where coinciding is wanting. I am a self in the identifying recurrence in which I find myself cast back to the hither side of my point of departure!
...
In opposition to the vision of thinkers such as Eugen Fink or Jeanne Delhomme, who require, among the conditions of the world, a freedom without responsibility, a freedom of play, we discern in obsession a responsibility that rests on no free commitment, 
a responsibility whose entry into being could be effected only without any choice.
...
It is because in an approach, there is inscribed or written the trace of infinity, the trace of a departure, but trace of what is inordinate, does not enter into the present, and inverts the archē into anarchy, that there is forsakeness of the other, obsession by him, responsibility and a self.
...
It is through the condition of being hostage that there can be in the world pity, compassion, pardon and proximity - 
even the little there is, even the simple "After you, sir." 
...
The ego is not an entity "capable" of expiating for the others: it is this original expiation. This expiation is voluntary, for it is prior to the will's initiative (prior to the origin).
...
The individuation or superindividuation of the ego consists in being in itself, in its skin, without sharing the conalus essendi of all beings which are beings in themselves. It consists in my being faced with everything that is only because I am by regard for all that is. It is an expiating for being.
...
COMMUNICATION 
It is with subjectivity understood as self, with the exciding and dispossession, the contraction, in which the ego does not appear, but immolates itself, that the relationship with the other can be communication and transcendence, and not always another way of seeking certainty, or the coinciding with oneself.
...
The overemphasis of openness is responsibility for the other to the point of substitution, where the for-the-other proper to disclosure, to monstration to the other, turns into the for-the-other proper to responsibility. This is the thesis of the present work.
...
Or is not the ego a substitution in its solidarity as something identical, a solidarity that begins by bearing witness of itself to the other? Is it not then first of all a communicating of communication, a sign of the giving of signs, and not a transmission of something in an openness?
...
For that is the itinerary by which theological and edifying thought too quickly deduces the truths of faith. Then obsession is subordinated to a principle that is stated in a theme, which annuls the very anarchy of its movement.
...
"FINITE FREEDOM" 
The views that have been expounded can then not be reproached for the imprudence of affirming that the first word of the "mind," that which makes all the others possible, and even the words "negativity" and "consciousness," would be naive unconditioned "Yes" of submission, negating truth, and all the highest values!
...
It is a passivity prior to all receptivity, 
it is transcendent.
...
This is an assignation to a non-erotic proximity, to a desire of the non-desirable, to a desire of the stranger in the neighbor. It is outside of concupiscence, which for its part does not cease to seduce by the appearance of the Good.
...
The responsibility for another, an unlimited responsibility which the strict book-keeping of the free and non-free does not measure, requires subjectivity as an irreplaceable hostage. This subjectivity it denudes under the ego in a passivity of persecution, repression and expulsion outside of essence, into oneself.
In this self, outside of essence, one is in a deathlike passivity!
But in responsibility for the other for life and death, the adjectives unconditional, undeclinable, absolute take on meaning. They serve to qualify freedom, but wear away the substrate, from which the free act arises in essence.
...
Freedom is borne by the responsibility it could not shoulder, an elevation and inspiration without complacency. The for-the-other characteristic of the subject can be interpreted neither as a guilt complex (which presupposes an initial freedom), nor as a natural benevolence or divine "instinct," nor as some love or some tendency to sacrifice. This is quite the opposite of the Fichtean conception, where all suffering due to the action of the non-ego is first a positing of this action of the non-ego by the ego.
...
It is brought out without being assumed, in the undergoing by sensibility beyond its capacity to undergo. This describes the suffering and vulnerabil ity of the sensible as the other in me.
The other is in me and in the midst of my very identification.  The ipseity has become at odds with itself in its return to itself.
The self-accusation of remorse gnaws away at the closed and firm core of consciousness, opening it, fissioning it. In consciousness equality and equilibrium between the trauma and the act is always reestablished. Or at least this equilibrium is sought in reflection and its figures, although the possibility of total reflection and of the unity of Mind, beyond the multiplicity of souls, is not effectively ensured.
...
Responsibility for the other, for what has not begun in me is responsibility in the innocence of being a hostage. My substitution for another is the trope of a sense that does not belong to the empirical order of psychological events, an Einfuhlung or a compassion which signify by virtue of this sense.
My substitution - 
it is as my own that substitution for the neighbor is produced.
...
I am unique and chosen; 
the election is in the subjection.
...
The accusation is in this sense persecuting; the persecuted one can no longer answer it. More exactly, it is accusation which I cannot answer, but for which I cannot decline responsibility.
...
It is a pure self, in the accusative, responsible before there is freedom. Whatever be the ways that lead to the superstructure of society, in justice the dissymetry that holds me at odds with regard to the other will find again law, autonomy, equality.
...
It is impossible to evade the appeal of the neighbor, to move away. One approaches the other perhaps in contingency, but henceforth one is not free to move away from him. The assumption of the suffering and the fault of another nowise goes beyond the passivity: it is a passion.
...
Death gives lie to pleasure, in which for the space of an instant the tragi-comedy is forgotten, and which would be defined by this forgetting. But despite all its adversity, it is accorded with the for-the-other of approach.
No one is so hypocritical as to claim that he has taken from death its sting, not even the promisers of religions. But we can have responsibilities and attachments through which death takes on a meaning. That is because, from the start, the other affects us despite ourselves.
If one had the right to retain one trait from a philosophical system and neglect all the details of its architecture (even though there are no details in architecture, according to Valery's profound dictum, which is eminently valid for philosophical construction, where the details alone prevent collapse), we would think here of Kantism, which finds a meaning to the human without measuring it by ontology and outside of the question "What is there here...?" that one would like to take to be preliminary, outside of the immortality and death which ontologies run up against.
...
SIGNIFICATION AND THE OBJECTIVE RELATION 
...
Nor would it have another signification if one attends to the communication of essence manifested to the other, if one takes the saying as a pure communication of a said.
...
A science would be able to totalize being at all levels of its esse by fixing the ontological structures that articu late being. Subjectivity, the ego and the others would be the signifiers and signified in which the subjective representation of being is realized.
...
The conjuncture in which a man is responsible for other men, the ethical relationship, which is habitually considered as belonging to a derivative or founded order, has been throughout this work approached as irreducible. It is structured as the-one-for-the-other. It signifies outside of all finality and every system, where finality is but one of the principles of systematization possible. This responsibility appears as a plot without a beginning, anarchic.
...
The models of being and the subject-object correlation, which are justifiable but derivative, do not depict signification, the-one-for-the-other. It indeed shows itself in the said, but does so only after the event, betrayed, foreign to the said of being; it shows itself in it as a contradiction - which incites Plato to parricide.
...
The-one-for-the-other is the foundation of theory, for it makes possible relationship, and the point outside of being, the point of disinterestedness, necessary for a truth that does not wish to be pure ideology. But it is not what one means by "committed subjectivity."
...
A committed consciousness, if it does not appear in the interference of the series in which it is thrown, is in situation. What is imposed on it is already measured, forms a condition and a site, in which, by dwelling, the obstacle of the incarnation of consciousness is inverted into freedom and origin - and its weight into past.
...
The summoned one is the ego - me. I repel and send away the neighbor through my very identity, my occupying the arena of being; I then have always to reestablish peace.
What in this signifying, in this the-one-for-the- other, can and must lead to knowing, to questioning, to the "what is this about...," the explicit formulation of a familiarity with being as though it had been antecedent and implicit - what in this signifying leads to ontology and thus to presence, to the shadowless high noon manifestation of truth, to reckoning, thought, settling down, institution-we will no doubt have to show.
...
But proximity, conceived independently of this spiritualism of consciousness and recognized as signification or goodness, allows us to understand goodness in another way than as an altruistic inclination to be satisfied. For signification, the-one-for-the-other, is never an enough, and the movement of signification does not return.
...
As a responsibility for the freedom of the other, it is prior to any freedom in me, but it also precedes violence in me, which would be the contrary of freedom. For if no one is good voluntarily, no one is a slave of the Good.
...
It is at the same time prior to commitments, for it disengages in this extreme passivity an undeclinable and unique subject. Responsibility, the signification which is non-indifference, goes one way, from me to the other.
...
In the saying in responsibility, the one is not concealed in itself, but denudes itself in recurrence, substituting itself for another on the hither side of its own identity for another. This is the only way for it to be not multiplied in this relationship, but for its unity to be brought out in it.
...
It is the signification of signs. It is the humanity of man not understood on the basis of transcendental subjectivity. It is the passivity of exposure, a passivity itself exposed. Saying does not occur in consciousness nor in a commitment understood in terms of consciousness or memory; it does not form a conjuncture and a synchrony.
Proximity is fraternity before essence and before death, having a meaning despite being and nothingness, despite concepts.
Signification as proximity is thus the latent birth of the subject. Latent birth, for prior to an origin, an initiative, a present designatable and assumable, even if by memory.
...
One runs the risk of, or persists in taking the signification of the-one-for-the-other to be a limited or particular phenomenon, the "ethical aspect of being." But it is necessary to ask if in it there is not heard a voice coming from horizons at least as vast as those in which ontology is situated.
THE GLORY OF THE INFINITE a.
Inspiration 
The assembling of being in the present, its synchronization by retention, memory and history, reminiscence, is representation; it does not integrate the responsibility for the separated entity.
Representation does not integrate the responsibility for the other inscribed in human fraternity; 
human fraternity does not arise out of any commitment, any principle, that is, any recallable present.
...
This book has exposed the signification of subjectivity in the extraordinary everydayness of my responsibility for other men, the extraordinary forgetting of death or the being without regard for death. The signification of my responsibility for what escapes my freedom is the defeat or defecting of the unity of transcendental apperception, the originary actuality of every act, source of the spontaneity of the subject or of the subject as a spontaneity.
...
In its identity invoked the one is irreplaceable, and does not return to itself; in its bearing of itself, it is an expiation for the other, in its "essence" an exception to essence, or a substitution.
...
Through this alteration the soul animates the object; 
it is the very pneuma of the psyche.
...
It is an undoing of the substantial nucleus of the ego that is formed in the same, a fission of the mysterious nucleus of inwardness of the subject by this assignation to respond, which does not leave any place of refuge, any chance to slip away, and is thus despite the ego, or, more exactly, despite me.  Quite the contrary of nonsense, it is an alteration without alienation or election.
The subject in responsibility is alienated in the depths of its identity with an alienation that does not empty the same of its identity, but constrains it to it, with an unimpeachable assignation, constrains it to it as no one else, where no one could replace it.
The psyche, a uniqueness outside of con' cepts, is a seed of folly, already a psychosis. It is not an ego, but me under assignation.
...
To this command continually put forth only a "here I am" (me void) can answer, where the pronoun "I" is in the accusative, declined before any declension, possessed by the other, sick, identical.
...
For Descartes the union of the soul and the body would presuppose a miraculous intervention, for Descartes looks for it, according to the rationality of representations, as an assembling and a simultaneity of distinct terms. He understands the soul to be a thematizing thought.
...
It is the subjectivity of a man of flesh and blood, more passive in its extradition to the other than the passivity of effects in a causal chain, for it is beyond the unity of apperception of the I think, which is actuality itself. It is a being torn up from oneself for another in the giving to the other of the bread out of one's own mouth.
...
h. Inspiration and Witness 
But does not this exposure, this exile, this interdiction to remain in oneself revert into a position, and in pain itself, into complacency puffing itself up with substance and pride?
...
It is the extreme tension of language, the for-the-other of proximity, which closes in on me from all sides and concerns me even in my identity. The logos of monologue or of dialogue will have already relaxed its potential, by scattering into possibilities of being, playing between the couples: conscious-unconscious, explicit-implicit.
...
The response is put forth for the other, without any "taking up of attitudes." This responsibility is like a cellular irritability; it is the impossibility of being silent, the scandal of sincerity.
Sincerity is not an attribute of saying; it is saying that realizes sincerity. It is inseparable from giving, for it opens reserves from which the hand that gives draws without being able to dissimulate anything.
...
Does not the sense of sincerity refer to the glory of infinity, which calls for sincerity as for a saying?
...
But without a principle, without a beginning, and anarchy, glory breaks up themes and, prior to the logos, signifies positively the extraditing of the subject that rests on itself, to what it has never assumed. For, out of an unrepresentable past, the subject has been sensitive to the provocation that has never presented itself, but has struck traumatically.
Glory is but the other face of the passivity of the subject. Substituting itself for the other, a responsibility ordered to the first one on the scene, a responsibility for the neighbor, inspired by the other, I, the same, am torn up from my beginning in myself, my equality with myself.
The glory of the Infinite is glorified in this responsibility. It leaves to the subject no refuge in its secrecy that would protect it against being obsessed by the other, and cover over its evasion.
...
The glory of the Infinite is the anarchic identity of the subject flushed out without being able to slip away. It is the ego led to sincerity, making signs to the other, for whom and before whom I am responsible, of this very giving of signs, that is, of this responsibility: "here am." 
...
The distance that is enlarged in the measure that proximity narrows, the glory of infinity, is the inequality between the same and the other, the difference that is also the non-indifference of the same for the other and the substitution which, in its turn, is a nonequality with oneself, a non-recovering of self by self, a dispossession of self, the self leaving the clandestinity of its identification. It is already a sign made to another, a sign of this giving of signs, that is, of this non-indifference, a sign of this impossibility of slipping away and being replaced, of this identity, this uniqueness: here I am.
The identity aroused thus behind identification is an identity by pure election.
Election traverses the concept of the ego to summon me as me through the inordinateness of the other. It extracts me from the concept in which I continually take refuge, for I find in it the measure of an obligation which is not defined in the election.
...
It is not self-consciousness attaining itself in the present, but the extreme exposure to the assignation by the other, already realized behind consciousness and freedom. The assignation is entry into me by burglary, that is, without showing itself, speaking in the saying of the assigned one.
...
Subjectivity is from the first substitution offered in place of another, but before the distinction between freedom and nonfreedom. Not a victim offering itself in his place, which would suppose there is a reserved region of subjective will behind the subjectivity of substitution.
...
The subjectivity of the subject, as being subject to everything, is a pre-originary susceptibility, before all freedom and outside of every present. It is accused in uneasiness or the unconditionality of the accusative, in the "here I am" (me void) which is obedience to the glory of the Infinite that orders me to the other.
"Each of us is guilty before everyone for everyone, and I more than the others," writes Dostoyevsky in Brothers Karamazov.
The subjectivity of the subject is persecution and martyrdom. It is a recurrence which is not self-consciousness, in which the subject would still be maintained distant from itself in non-indifference, would still remain somehow in itself and be able to veil its face. This recurrence is not self-coinciding, rest, sleep or materiality.
It is a recurrence on this side of oneself, prior to indifference to itself. It is a substitution for another. In the interval, it is one without attributes, and not even the unity of the one doubles it up as an essential attribute.
...
No theme, no present, has a capacity for the Infinite. The subject in which the other is in the same, inasmuch as the same is for the other, bears witness to it. The difference of proximity is absorbed in the measure that proximity becomes closer, and by this very absorption is brought out gloriously, and accuses me always more.
The same' in its bearing as same is more and more extended to the other, to the point of substitution as a hostage. Expiation coincides in the last analysis with the extraordinary and diachronic reversal of the same into the other, in inspiration and the psyche.
...
This plot connects to what detaches itself absolutely, to the Absolute. The detachment of the Infinite from the thought that seeks to thematize it and the language that tries to hold it in the said is what we have called illeity.
...
The Infinite passes in saying. This is what could be understood, when we see that saying is irreducible to an act, a psychological attitude, a state of soul, a thought among others, or a moment of being's essence, through which, one knows not why, man would double up his essence.
...
We call prophecy this reverting in which the perception of an order coincides with the signification of this order given to him that obeys it.
...
No structure is set up with a correlate. Thus the saying that comes to me is my own word.
...
Sign of what?
Of complicity?
Of a complicity for nothing, a fraternity, a proximity that is possible only as an openness of self, an imprudent exposure to the other, a passivity without reserve, to the point of substitution.  It is thus exposing of the exposure, saying, saying that does not say a word, that signifies, that, as responsibility, is signification itself, the-one-for-the-other.  It is the subjectivity of the subject that makes itself a sign, which one would be wrong to take as a babbling utterance of a word, for it bears witness to the glory of the Infinite.
...
It is the bottomless passivity of responsibility, and thus, sincerity. It is the meaning of language, before language scatters into words, into themes equal to the words and dissimulating in the said the openness of the saying exposed like a bleeding wound. But the trace of the witness given, the sincerity or glory, is not effaced even in its said.
...
The glory of the Infinite shuts itself up in a word and becomes a being. But it already undoes its dwelling and unsays itself without vanishing into nothingness. It invests being in the very copula with which it receives attributes. (It is receiving them at this very moment, when this semantic adventure is here being thematized.) 
...
The limits of the present in which infinity betrays itself break up. Infinity is beyond the scope of the unity of transcendental apperception, cannot be assembled into a present, and refuses being recollected.
This negation of the present and of representation finds its positive form in proximity, responsibility and substitution. This makes it different from the propositions of negative theology.
...
Its signification has let itself be betrayed in the logos only to convey itself before us. It is a word already stated as a kerygma in prayer or blasphemy.It thus retains in its statement the trace of the excession of transcendence, of the beyond.
...
In the play activating the cultural keyboard of language, sincerity or witness signifies by the very ambiguity of every said, where, in the midst of the information communicated to another there signifies also the sign that is given to him of this giving of signs. That is the resonance of every language "in the name of God," the inspiration or prophecy of all language.
...
The Infinite would be belied in the proof that the finite would like to give of its transcendence; entering into conjunction with the subject that would make it appear, 
it would lose its glory.
...
Not includable in the present, refractory to thematization and representation, the alterity of the neighbor calls for the irreplaceable singularity that lies in me, by accusing this ego, reducing it, in the accusative, to itself.
...
In subjectivity, subjected to everything, a sign gives over its plasticity and its function of being sign to the other, repeating, always anew, the exposure of what the exposure can outline as essence. This iteration of exposure is expression, sincerity, saying.
...
That is so, 
but then there is a new dilemma. Responsibility without a prior commitment, without a present, without an origin, anarchic, is thus an infinite responsibility of the one for the other who is abandoned to me without anyone being able to take my place as the one responsible for him. Does this confer upon me a new identity, that of being the unique chosen one?
...
By this contestation eveything is incumbent on me, and there is produced my entry into the designs of the Infinite. The enigma separates the Infinite from all phenom- enality, from appearing, thematization and essence.
...
What about our discussion, narrating, as though they were fixed in themes, the anarchy and the non-finality of the subject in which the Infinite would pass?They are thus found to answer in the end not with responsibility, but in the form of theoretical propositions, to the question "What about?"   They do not answer the proximity of the neighbor.
...
Everything is shown by indeed betraying its meaning, but philosophy is called upon to reduce that betrayal, by an abuse that justifies proximity itself in which the Infinite comes to pass.  But this remains to be shown.
...
It benefits from an ambiguity or an enigma, which is not the effect of an inattention, a relaxation of thought, but of an extreme proximity of the neighbor, where the Infinite comes to pass. The Infinite does not enter into a theme like a being to be given in it, and thus belie its beyond being.
...
The entry of a third party is the very fact of consciousness, assembling into being, and at the same time, in a being, the hour of the suspension of being in possibility, the finitude of essence accessible to the abstraction of concepts, to the memory that assembles in presence, the reduction of a being to the possible and the reckoning of possibles, the comparison of incomparables. It is the thematization of the same on the basis of the relationship with the other, starting with proximity and the immediacy of saying prior to problems, whereas the identification of knowing by itself absorbs every other.
...
The other is from the first the brother of all the other men. The neighbor that obsesses me is already a face, both comparable and incomparable, a unique face and in relationship with faces, which are visible in the concern for justice.
...
Everything is together, one can go from the one to the other and from the other to the one, put into relationship, judge, know, ask "what about...?", transform matter.
...
This means concretely or empirically that justice is not a legality regulating human masses, from which a technique of social equilibrium is drawn, harmonizing antagonistic forces. That would be a justification of the State delivered over to its own necessities.
...
Justice, society, the State and its institutions, exchanges and work are comprehensible out of proximity. This means that nothing is outside of the control of the responsibility of the one for the other.
...
An event like meditation - synchronization, comparison, thematization - is the work of justice, an entry of the diachrony of proximity, of the signifyingness of saying into the synchrony ' of the said, a "fundamental historicity" in the sense of Merleau-Ponty. It is the necessary interruption of the Infinite being fixed in structures, community and totality.
...
The pre-original, anarchic saying is proximity, contact, duty without end, a saying still indifferent to the said and saying itself without giving the said, the-one-for-the-other, a substitution. It requires the signification of the thematizable, states the idealized said, weighs and judges in justice.
...
From signification proceed justice and consciousness: the terms of the-one- for-the-other appear in a theme, in the said, are compared and judged in the neutrality of essence.
...
With that right does the idealist extract the ego from being and confer upon it a transcendental status, when the subject returns to being in the very stability of its status?
But the forgetting of ambiguity would be as little philosophical.
It is in its exception and ex-pulsion as a responsible one that a subject outside of being can be conceived.
...
The one in the-one-for-the-other is not a being outside of being, but signification, evacuation of Being's essence for the other. The self is a substitution for the other, subjectivity as a subjection to everything, as a supporting everything and supporting the whole.
...
Reason is sought in the relationship between terms, between the one and the other showing themselves in a theme.
...
But the present of the theme, where the one and the other enter into signification or become significations, is correlative with a subject which is a consciousness. Its subjectivity consists in rendering present, that is, in not being struck without being forewarned by the manifestation of what strikes, in not being disturbed from beyond the visible and the thematizable.
The flow of time does not break up this presence and this presentation: through retention, memory or historical reconstruction, through reminiscence consciousness is a re-presentation, understood in an almost active sense, as in the act of rendering present anew and of collecting the dispersion into a presence, and in this sense being always at the beginning or free.
...
Peace then is under my responsibility. I am a hostage, for I am alone to wage it, running a fine risk, dangerously. This danger will appear to knowing as an uncertainty, but it is transcendence itself, before certainty and uncertainty, which arise only in knowledge.
To require that a communication be sure of being heard is to confuse communication and knowledge, to efface the difference, to fail to recognize the signifyingness of the-one-for- the-other in me. I am extracted from the concept of the ego, and am not measured by being and death, that is, escape the totality and structures. I am reduced to myself in responsibility, outside of the fundamental historicity Merleau-Ponty speaks of.
...
This relationship is religion, exceeding the psychology of faith and of the loss of faith. It orders me in an anarchic way, without ever becoming or being made into a presence or a disclosure of a principle.
...
An impossible simulta- peousness of meaning, the non-assemblable but also inseparable one-for- the-other, is an excluded middle signifying as an equivocation or an enigma. And yet can not this very beyond become a notion, while undoing itself?
...
The approach, or saying, is a relationship with what is not understood in the together, the out-of-the-series. A subversion of essence, it overflows the theme it states, the "all together," the "everything included" of the said.
...
IN OTHER WORDS 
CHAPTER VI OUTSIDE
 Mephistopheles: Willst du nur horen was du schon gehort? Dich store nichts, wie es auch weiter klinge Schon langst gewohnt dcr wunderbarsten Dinge Faust: Doch im Erstarren such ich nicht mein Heil Das Schaudern ist der Menschheit bester Teil Goethe, Faust II, Act I.
...
Essence would never have had to be revealed through a detour, passing through humanity. The energy of its movement in the efficacity of praxis in which the abstract and as it were asthenic concept takes hold of the immediate to fashion it according to its own idea by institutions and laws.
...
Does subjectivity draw its own meaning from it? Is it brought out as a struggle for existence, to let itself be seduced by the power of powers, in the violences of nationalism, even when it hypocritically pretends to be only at the service of essence and not to will will?
...
The-one-for-the-other is the very signifyingness of signification.
How can such a research be undertaken without introducing some barbarisms in the language of philosophy? Yet philosophy has, at its highest, exceptional, hours stated the beyond of being and the one distinct from being, but mainly remained at home in saying being, that is, inwardness to being, the being at home with oneself, of which European history itself has been the conquest and jealous defense.
...
Can one avoid the schema of an intentional subject, which is will, inwardness in being, interest? In it the psyche, humanity, would be converted into "experience" and transcendence, into an aim after background worlds of the celestial city gravitating in the skies of the earthly city.
...
For here there is a complex of significations deeper and broader than freedom, which freedom animates. Freedom is animation itself, breath, the breathing of outside air, where inwardness frees itself from itself, and is exposed to all the winds.
...
The restlessness of respiration, the exile in oneself, the in itself without rest, is not an impossibility of inhabiting that would already become a movement from here to yonder; it is a panting, a trembling of substantiality, a hither side of the here. There is a passivity in the exposure, which does not succeed in taking form.
...
The approach of the neighbor is a fission of the subject beyond lungs, in the resistant nucleus of the ego, in the undividedness of its individuality. It is a fission of self, or the self as fissibility, a passivity more passive still than the passivity of matter.
...
This reduction is then an incessant unsaying of the said, a reduction to the saying always betrayed by the said, whose words are defined by non-defined words; it is a movement going from said to unsaid in which the meaning shows itself, eclipses and shows itself. In this navigation the element that bears the embarkation is also the element that submerges it and threatens to sink it.
...
It is in my bearing of myself, not to conduct myself well, but by my unicity as a unique being to expiate for the other.
...
In their essence are not these ecstatic moments already degraded into reflections of our own looks, into mirages of our needs, echoes of our prayers?
...
Everything that claims to come from elsewhere, even the marvels of which essence itself is capable, even the surprising possibilities of renewal by technology and magic, even the perfections of gods peopling the heights of this world, and their immortality and the immortality they promise mortals-all this does not deaden the heartrending bustling of the there is recommencing behind every negation.
