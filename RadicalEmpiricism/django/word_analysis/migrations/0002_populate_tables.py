...
from ...population_scripts.b_populate_english_translation import populate_english_translation
...
from ...population_scripts.f_populate_french_etymology import populate_french_etymology
