...
nav_items = [
    ...
    {"route": "genre_theory", "title": _("Theory of Genre Sets"), "explanation": _(
     ...
     "subitems": [
         ...
         {"route": "#perversion", "title": _("Perversion"), "explanation": _("")},
         {"route": "#inversion", "title": _("Inversion"), "explanation": _("")},
         {"route": "#subversion", "title": _("Subversion"), "explanation": _("")},
         {"route": "#reversion", "title": _("Reversion"), "explanation": _("")},
